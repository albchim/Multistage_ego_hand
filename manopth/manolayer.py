...
class ManoLayer(Module):
    ...
    def forward(self,
        ...
        tip_joints=th_v_shaped[:, [745, 317, 444, 556, 673]]
        ...
        th_jtr = th_jtr * 1000
        return th_verts, th_jtr, torch.cat([th_j,tip_joints],dim=1)[:, [0, 13, 14, 15, 16, 1, 2, 3, 17, 4, 5, 6, 18, 10, 11, 12, 19, 7, 8, 9, 20]]*1000
